        ...
        <div id="navigation">
            ...
            <nav className="navbar navbar-expand-lg navbar-light">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li className="nav-item"><a className="nav-link" href="dao-tao">Chương trình Đào tạo</a></li>
                    <li className="nav-item"><a className="nav-link" href="account-teacher">Tài khoản giảng viên</a></li>
                    <li className="nav-item"><a className="nav-link" href="account-student">Tài khoản sinh viên</a></li>
                    {ctdt}
                    {authen}
                    </ul>
                </div>
